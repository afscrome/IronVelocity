...
namespace IronVelocity.Tests.TemplateExecution
{
    ...
    public class PrecedenceTests : TemplateExeuctionBase
    {
        ...
        [TestCase("false == true > false", false, TestName = "when_ExecutingAnExpression_RelationalHasHigherPrecedenceThanEquality")]
        ...
        [TestCase("(false == true) > false", null, TestName = "when_ExecutingAnExpression_ParenthesiedExpressionHasHigherPrecedence3")]

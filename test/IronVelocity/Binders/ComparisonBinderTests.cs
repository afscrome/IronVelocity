...
namespace IronVelocity.Tests.Binders
{
    ...
    public class ComparisonBinderTests : BinderTestBase
    {
        ...
        private static IEnumerable<TestCaseData> GenerateTestCaseData(object left, object right, bool areEqual, bool? isGreaterThan, bool? isLessThan, string testNamePrefix)
        {

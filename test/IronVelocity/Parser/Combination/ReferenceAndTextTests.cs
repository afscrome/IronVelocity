...
namespace IronVelocity.Tests.Parser.Combination
{
    public class ReferenceAndTextTests : ParserTestBase
    {
        ...
        public static IEnumerable<TestCaseData> TwoReferencesWithPotentiallyAmbigiousCharcterInBetween()
        {
        ...
        public static IEnumerable<TestCaseData> CombinationTestSource()
        {
        ...
        public static IEnumerable<TestCaseData> CreateCombinationTestsWithTwoNodeResult(SampleType leftType, SampleType rightType)
        {

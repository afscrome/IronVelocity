...
namespace IronVelocity.Tests.Parser.Combination
{
    ...
    public class CommentCombinationTests : ParserTestBase
    {
        ...
        public static IEnumerable<TestCaseData> CommentCombinationTestCases()
        {
        ...
        private static IEnumerable<TestCaseData> EnumerateSampleCombinations(SampleType leftType, SampleType rightType)
        {
